...
export function getAdminNavItems({
  ...
  const allItems: AdminNavItemConfig[] = [
    ...
    {
      id: "vendor_portal",
      to: "/admin/b/$slug/vendor-portal",
      params: { slug: activeSlug },
      labelEn: "Vendor Portal",
      labelAr: lang === "ar" ? "🏛️ بوابة المستأجرين" : "🏛️ Vendor Portal",
      icon: Building2,
      permission: "manage_orders",
      section: "incubator",
    },
    {
      id: "contracts",
      to: "/admin/b/$slug/contracts",
      params: { slug: activeSlug },
      labelEn: "Vendor Contracts & Rent Invoices",
      labelAr: lang === "ar" ? "📄 العقود وفواتير الإيجار" : "📄 Vendor Contracts & Rent Invoices",
      icon: FileText,
      permission: "manage_orders",
      section: "incubator",
    },
