...
-- Add CMS pages, WhatsApp floating button config, and expose checkout button + new fields via the public view.
...
-- Refresh column-level GRANTs for anon direct table reads (add new + previously-missed checkout cols).
...
GRANT SELECT (
  ...
  pages, whatsapp_enabled, whatsapp_number
